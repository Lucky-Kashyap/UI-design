...
export const HERO = {
  ...
  description:
    'A Jaipur multi-venture house spanning premium clothing manufacturing, world-class education, luxury hospitality, and eco-adventure.',
...
export const ABOUT = {
  ...
  title: 'About us',
  body:
    'Traditional Group is a diverse multi-venture organisation dedicated to quality and innovation across manufacturing, education, luxury hospitality, and eco-adventure.',
  sectors: [
