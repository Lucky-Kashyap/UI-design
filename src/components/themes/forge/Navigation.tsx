    ...
    >
      <ForgeContainer className="flex min-w-0 items-center justify-between gap-3 py-3 xs:gap-4 md:py-4">
        ...
        <a
          ...
          className="fg-btn fg-btn--ghost fg-nav-cta shrink-0 px-5"
        >
          {FORGE_CTA.label}
        </a>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fg-mobile-menu overflow-hidden border-t border-tg-line bg-tg-bg lg:hidden"
            role="navigation"
          ...
          >
            <ForgeContainer className="flex flex-col gap-1 py-3 xs:py-4">
              ...
              <motion.a
                ...
                className="fg-btn fg-btn--primary mt-2 w-full min-h-[2.75rem] xs:mt-3"
              >
                {FORGE_CTA.label}
              </motion.a>
            </ForgeContainer>
